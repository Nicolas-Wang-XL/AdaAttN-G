...
class artvggMapSelfAdaAttNModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--art_map', type=str, default=None,
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['c', 'cs', 's', 'c_org', 'cs_org', 's_org', 'ap']#, 'edge_c', 'edge_cs', 'edge_s']
        self.model_names = ['decoder', 'artmap']
        parameters = []
